      ...
      <div class ="container">
        <form action="form-new-party-2" method="post">
          <div class ="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="pName" placeholder="20 characters max" value=""<?php if(!empty($_POST['pName'])){ echo htmlspecialchars($_POST['pName'], ENT_QUOTES);}"" ?> required>
            </div>
          </div>
